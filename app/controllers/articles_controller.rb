class ArticlesController < ApplicationController
  ...
  def new
    ...
    @anime_id = params[:anime_id].to_i unless params[:anime_id] == nil
    @title    = params[:title]         unless params[:title]    == nil
    @video_id = params[:video_id].to_i unless params[:video_id] == nil
  ...
  private
    ...
    def article_params
      params.require(:article).permit(:anime_id, :title, :video_id, :content, :oped, :number, :advertisement, :initials)
    end
end
